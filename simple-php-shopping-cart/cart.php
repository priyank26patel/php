...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		?>
				<form method="post" action="cart.php?action=add&code=<?php echo $item["code"]; ?>">
				<tr>
				<td><strong><?php echo $item["name"]; ?></strong></td>
				<td><?php echo $item["code"]; ?></td>
				<td><input type="text" name="quantity" value="<?php echo $item["quantity"]; ?>" size="2" /></td>
...
<td><a href="paypal/paypal.php">Checkout</a></td>
</tr>
</tbody>
</table>		
  <?php
